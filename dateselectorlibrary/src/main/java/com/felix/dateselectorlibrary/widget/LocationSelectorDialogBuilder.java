...
import com.felix.dateselectorlibrary.animation.Effectstype;
...
public class LocationSelectorDialogBuilder extends NiftyDialogBuilder implements View.OnClickListener {
    ...
    public interface OnSaveLocationLister {
        void onSaveLocation(String location, String provinceId, String cityId);
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.fl_dialog_title_previous) {
            dismiss();
        } else if (v.getId() == R.id.fl_dialog_title_next) {
     ...
     * 设置点击保存的监听
     *
     * @param saveLocationLister OnSaveLocationLister
     */
