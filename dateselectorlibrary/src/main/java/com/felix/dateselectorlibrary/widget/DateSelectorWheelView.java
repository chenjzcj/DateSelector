package com.felix.dateselectorlibrary.widget;
...
import com.felix.dateselectorlibrary.R;
import com.felix.dateselectorlibrary.utils.DateUtils;
import com.felix.dateselectorlibrary.wheelview.OnWheelChangedListener;
import com.felix.dateselectorlibrary.wheelview.StrericWheelAdapter;
import com.felix.dateselectorlibrary.wheelview.WheelView;
...
public class DateSelectorWheelView extends RelativeLayout implements
    ...
    public void onChanged(WheelView wheel, int oldValue, int newValue) {
        ...
        if (id == R.id.wv_date_of_year) {
        ...
        } else if (id == R.id.wv_date_of_month) {
            trim = DateUtils.splitDateString(wvMonth.getCurrentItemValue()).trim();
            ...
            tvDay.setText(DateUtils.splitDateString(wvDay.getCurrentItemValue()).trim());
        }
    }
